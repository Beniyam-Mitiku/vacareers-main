...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__.registerBlockType)("vacareers/button", {
  title: "Button",
  category: "va-blocks",
  attributes: {
    text: {
...
function EditComponent(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const parentBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.select)('core/block-editor').getBlockParents(clientId);
    setInSpotlight(parentBlocks.some(block => (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.select)('core/block-editor').getBlockName(block) == 'vacareers/spotlight'));

    if (!inSpotlight) {
      setAttributes({
        inSoptlightModal: false
      });
    }
  }, []);
  const [isLinkPickerVisible, setIsLinkPickerVisible] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [inSpotlight, setInSpotlight] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
  ...
  }))), inSpotlight && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: "Spotlight Modal",
    initialOpen: true
    ...
    label: "Open spotlight modal",
    help: "Select if you want this button to open the spotlight modal",
    checked: isSpotlightModal,
    onChange: handleIsModalChange
    ...
    allowedFormats: [],
    tagName: "a",
    className: `usa-button usa-button--${buttonStyle}`,
    value: text,
